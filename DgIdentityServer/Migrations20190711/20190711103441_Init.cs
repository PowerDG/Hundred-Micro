...
namespace Research.Migrations
{
    ...
    onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "AbpEntityChanges",
                columns: new[] { "entity_type_full_name", "EntityId" });
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "tenant_id", "Source", "LanguageName", "Key" });

            migrationBuilder.CreateIndex(
                name: "IX_AbpNotificationSubscriptions_NotificationName_EntityTypeName~",
                table: "AbpNotificationSubscriptions",
                columns: new[] { "NotificationName", "entity_type_name", "EntityId", "user_id" });

            migrationBuilder.CreateIndex(
                name: "IX_AbpNotificationSubscriptions_TenantId_NotificationName_Entit~",
                table: "AbpNotificationSubscriptions",
                columns: new[] { "tenant_id", "NotificationName", "entity_type_name", "EntityId", "user_id" });
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "AbpUserLogins",
                columns: new[] { "tenant_id", "login_provider", "ProviderKey" });
